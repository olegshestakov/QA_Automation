...
//        // special symbols [ \ ^ $ . | ? * + ( )
        ...
        // set
        testRegularExpressionAndPrintResult("[fcp]ar", "far car par");
//
//        // ranges
        testRegularExpressionAndPrintResult("x[0-9A-F][0-9A-F]", "Exception 0xAF");
        testRegularExpressionAndPrintResult("[a-zA-Zа-яА-ЯёЁ]", "Ёжик Rocket67");
//
//        // \d – the same [0-9],
...
//        // except ranges
        ...
        testRegularExpressionAndPrintResult("\\d{5}", "I'm 12345 75665565");
        testRegularExpressionAndPrintResult("\\d{3,5}", "I'm 123 4 6786 75665565");
        testRegularExpressionAndPrintResult("\\d{3,}", "I'm 123 4 6786 46575757");
        testRegularExpressionAndPrintResult("\\d{3,15}", "I'm 123 4 6786 333333333333333 465755656565656565656565656565656565656454757");
//        testRegularExpressionAndPrintResult("\\d{,15}", "I'm 123 4 6786 333333333333333 465755656565656565656565656565656565656454757");
//
//        // + one or more
        testRegularExpressionAndPrintResult("\\d+", "+7(903)-123-45-67");
//
//        // ? zero or one
        testRegularExpressionAndPrintResult("colou?r", "We can write color or colour (britain variant), and colot");
//
//        // * zero or more
        testRegularExpressionAndPrintResult("\\d2*", "122 12 1 22 13");
        //</editor-fold>

        //<editor-fold desc="Groups">
        testRegularExpressionAndPrintResult("(go)+", "Gogogo gogo God ogo");
//
//        // lazy quantificator +?, *?, ??
